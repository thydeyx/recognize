...
python text_recognition/Turi_Train.py ${train_image_dir_path} ${train_gt_dir_path} ${validation_image_dir_path} ${validation_gt_dir_path} ${output_dir_path} > log/train_log_${suffix}.txt
python text_recognition/Turi_Test.py ${test_image_dir_path} ${test_gt_dir_path} ${model_dir_path} > log/test_log_${suffix}.txt
