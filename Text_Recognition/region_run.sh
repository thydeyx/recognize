...
prefix=/home/sdb/maxi/Data/Image_Process/ICDAR2011
suffix=region
...
python text_recognition/Region_Classifier_Train.py ${train_image_dir_path} ${train_gt_dir_path} ${validation_image_dir_path} ${validation_gt_dir_path} ${vgg_model_path} ${config_path} ${output_dir_path} > log/train_log_${suffix}.txt
python text_recognition/Region_Classifier_Test.py ${test_image_dir_path} ${test_gt_dir_path} ${model_dir_path} ${normal_para_npy_path} ${config_path} > log/test_log_${suffix}.txt
