...
def main():
    ...
    image_batch_size = config_dict["image_batch_size"];
    proposal_batch_size = config_dict["proposal_batch_size"];
    ...
    RPN.model_train(train_imdb_obj, val_imdb_obj, vgg_model_path, image_batch_size, proposal_batch_size, basic_lr, step, output_dir_path);
