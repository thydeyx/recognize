...
from Prediction import Image_Classification
...
def main():
    ...
    test_imdb_obj.prepare_region_data(region_height, region_width);
    ...
    output_node_name_list = ["predictions/prob"];
    ...
    Image_Classification.tf_metrics_report(test_imdb_obj, frozen_model_path);

    # coreml_model = Model_Convert.tf2coreml(frozen_model_path, coreml_model_path);
